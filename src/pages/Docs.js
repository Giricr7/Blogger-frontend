    ...
    <div className="container mt-3">
      <div className="card p-3 mb-3">
        <div className="banner">
          <h1>Hello, Welcome to my Docs!</h1>
        </div>
        <div className="mt-3">
          <h3>Info :</h3>
          <ul className="list">
            <li>Blogger is a MERN Blogging website.</li>
            <li>
              This is a blogging website where users can create, edit ,delete
              and comment on the post
            </li>
            <li>
              Users are required to login first in order to create and comment on
              posts.
            </li>
            <li>
